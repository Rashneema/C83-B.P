...
export default class StoryScreen extends Component {
   ...
   //S.A -create text-to-speech function 
  async initiateTTS(title, author, story, moral) {
    ...
    render() {
        //as we are indirectly reaching out to the parameters from Feed.js, have to mention this.props.route.params instead of this.props
                    ...
                    <View style={styles.storyContainer}>
                        <ScrollView style={styles.storyCard}>
                            ...
                            <View style={styles.dataContainer}>
                                ...
                                <TouchableOpacity //S.A -writing this touchable opacity
                    onPress={() =>
                      this.initiateTTS(
                        this.props.route.params.story.title,
                        this.props.route.params.story.author,
